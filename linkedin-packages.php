						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-md-7 col-lg-6">
								<div class="txt-block right-column wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
									...
									<!-- TEXT BOX -->
									<div class="txt-box">
										<p class="p-lg">You can expect the following from our professionally managed campaigns:</p>
										<!-- List -->
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Profile Image Creation</p>
								</li>
								<li>
									<p class="p-md">Cover Photo Creation</p>
								</li>
								<li>
									<p class="p-md">3 - Post Per Week</p>
								</li>
								<li>
									<p class="p-md">Keyword Based Content For Postings</p>
								</li>
								<li>
									<p class="p-md">Video Optimization</p>
								</li>
								<li>
									<p class="p-md">Infographics Creation</p>
								</li>
								<li>
									<p class="p-md">Content Writing</p>
								</li>
								<li>
									<p class="p-md">Company Business Page Creation</p>
								</li>
								<li>
									<p class="p-md">Add LinkedIn URL To Your Website</p>
								</li>
								<li>
								...
								<li>
									<p class="p-md"><span>Professional LinkedIn Marketing Consulting</span></p>
								</li>
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Spam Monitoring</p>
								</li>
								<li>
									<p class="p-md">Content Writing</p>
								</li>
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Integrating embedded posts</p>
								</li>
								<li>
									<p class="p-md">Monthly Reporting</p>
								</li>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
											<b>What is LinkedIn marketing?</b>
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingFive">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
											<b>How successful is marketing on LinkedIn?</b>
										</button>
									</h2>
									<div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											...
											<!-- TEXT BOX -->
											<div class="txt-box">
												<p class="p-lg">Here are a few advantages of LinkedIn marketing that you should know:
												</p>
												<!-- List -->
												<ul class="simple-list">

													<li class="list-item">
														<p class="p-lg">45% of marketers report using LinkedIn to help with client acquisition.
														</p>
													</li>

													<li class="list-item">
														<p class="p-lg">Of all B2B leads, LinkedIn accounts for 80%.
														</p>
													</li>

													<li class="list-item">
														<p class="p-lg">Additionally, it represents more than 50% of all social traffic to B2B websites.
														</p>
													</li>

													<li class="list-item">
														<p class="p-lg">It generates leads 277% more effectively than Facebook.
														</p>
													</li>

													<li class="list-item">
														<p class="p-lg">91% of executives said that they prefer LinkedIn for finding content that is relevant to their careers.
														</p>
													</li>
