				...
				<div class="row row-cols-1 row-cols-md-3">
					...
					<div class="col">
						<div class="fbox-8 mb-40 wow fadeInUp">
							...
							<!-- Image -->
							<div class="fbox-img bg-whitesmoke-gradient">
								<img class="homeimgsize" src="https://clickboxagency.com/images/logodesign-img06.jpg" alt="feature-icon" />
							</div>
				...
				<div class="row row-cols-1 row-cols-md-3">
					...
					<div class="col">
						<div class="fbox-8 mb-40 wow fadeInUp">
							...
							<!-- Image -->
							<div class="fbox-img bg-whitesmoke-gradient">
								<img class="homeimgsize" src="https://clickboxagency.com/images/ui-design-and-prototyping.png" alt="feature-icon" />
							</div>
					...
					<div class="col">
						<div class="fbox-8 mb-40 wow fadeInUp">
							...
							<!-- Image -->
							<div class="fbox-img bg-whitesmoke-gradient">
								<img class="homeimgsize" src="https://clickboxagency.com/images/logodesign-img02.jpg" alt="feature-icon" />
							</div>
