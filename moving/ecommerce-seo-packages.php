...
<body>
	...
	<section id="content-3" class="bg-snow content-3 inner-page-hero pt-30 pb-30 content-section division">
		<div class="container">
			<!-- Title -->
			...
			<div class="fbox-8-wrapper text-center">
				<div class="row row-cols-1 row-cols-md-3">
					...
					<div class="col">
						<div class="fbox-8 mb-40 wow fadeInUp">
							<div class="fbox-img bg-whitesmoke-gradient">
								<img class="img-fluid" src="../images/26.png" alt="creative digital marketing company new jersey" />
							</div>
					...
					<div class="col">
						<div class="fbox-8 mb-40 wow fadeInUp">
							<!-- Image -->
							<div class="fbox-img bg-whitesmoke-gradient">
								<img class="img-fluid" src="../images/27.png" alt="Role of Community" />
							</div>
							<!-- Title -->
