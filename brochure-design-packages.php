						...
						<div class="col-md-6 col-lg-6">
							<div class="txt-block left-column wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
								...
								<div class="txt-box mb-30">
									<h5 class="h5-md">Targeted To Audience</h5>
									<p class="p-lg">Your website provides a comprehensive 360-degree view of your firm, but a high-quality business design gives the potential customer a single piece of information.</p>
									<!-- Title -->
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md"><span>Professional Brochure Design Consulting</span></p>
								</li>
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Social Media Promotion</p>
								</li>
								<li>
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Newsletter Promotion</p>
								</li>
								<li>
									<p class="p-md">Social Media Promotion</p>
								</li>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
											<b>Do you take on small projects?</b>
										</button>
									</h2>
									...
									<div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											<ul class="simple-list">
												...
												<li class="list-item">
													<p class="p-lg">For Print Media- PDF.
													</p>
												</li>

												<li class="list-item">
													<p class="p-lg">For banners, posters, etc., -JPG.
													</p>
												</li>
