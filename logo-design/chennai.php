				...
				<div class="row d-flex align-items-center">
					...
					<div class="col-md-5 col-lg-6">
						<div class="img-block right-column wow fadeInLeft">
							<img class="img-fluid" src="https://www.clickboxagency.com/images/img-13.png" alt="content-image">
						</div>
					</div>
				...
				<div class="row d-flex align-items-center">
					...
					<div class="col-md-5 col-lg-6">
						<div class="img-block left-column wow fadeInRight">
							<img class="img-fluid" src="https://www.clickboxagency.com/images/img-06.png" alt="content-image">
						</div>
					</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-5 col-lg-6">
					<div class="rel img-block left-column video-preview wow fadeInRight">
						<!-- Preview Image -->
						<img class="img-fluid" src="https://www.clickboxagency.com/images/img-08.png" alt="video-preview">
	...
	<script type="application/ld+json">
		{
			...
			"@type": "WebSite",
			"url": "https://www.clickboxagency.com/logo-design/chennai/"
			"potentialAction": {
				"@type": "SearchAction",
				"target": "https://www.clickboxagency.com/logo-design/chennai/find?q={search_term_string}",
