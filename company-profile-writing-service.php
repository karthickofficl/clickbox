...
<head>
	...
	<link rel="canonical" href="https://www.clickboxagency.com/company-profile-writing-service/" />

	<meta name="viewport" content="width=device-width, initial-scale=1">

	<meta property="og:type" content="website" />

	<meta property="og:url" content="https://www.clickboxagency.com/company-profile-writing-service/" />

	<meta property="og:site_name" content="https://www.clickboxagency.com/company-profile-writing-service/" />
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-lg-5 order-last order-lg-2">
					<div class="hero-8-img pc-20 text-center">
						<img class="img-fluid" src="../images/corporate profile writing/1.png" alt="hero-image">
					</div>
				</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-12 col-lg-5">
					<div class="img-block right-column wow fadeInLeft">
						<img class="img-fluid" src="../images/corporate profile writing/2.png" alt="content-image">
					</div>
				</div>
				...
				<div class="row d-flex align-items-center">
					...
					<div class="col-md-5 col-lg-6">
						<div class="img-block left-column wow fadeInLeft">
							<img class="img-fluid" src="../images/corporate profile writing/3.png" alt="content-image">
						</div>
					</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-5 col-lg-6">
					<div class="rel img-block left-column wow fadeInRight">
						<img class="img-fluid" src="../images/corporate profile writing/4.png" alt="video-preview">
					</div>
				</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-5 col-lg-6 order-first order-md-2">
					<div class="rel img-block right-column wow fadeInLeft">
						<img class="img-fluid" src="../images/corporate profile writing/5.png" alt="content-image">
					</div>
				</div>
