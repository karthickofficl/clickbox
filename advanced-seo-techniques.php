...
if (isset($_POST['send'])) {
	...
	$subject = 'Enquiry From SEO Techniques';
				...
				<div class="col-lg-10 offset-lg-1">
					<div class="single-post-wrapper">
						...
						<div class="single-post-txt">
							...
							<!-- Title -->
							<h4 class="h4-lg">Reasons why your website is not ranking in search results</h4>

							<ul class="digit-list">
								<li>
									<p class="p-lg">● Competitors have better content</p>
								</li>
								<li>
									<p class="p-lg">● Utilizing weak keywords</p>
								</li>
								<li>
									<p class="p-lg">● Using poor link building practices</p>
								</li>
								<li>
									<p class="p-lg">● Slow webpage load time </p>
								</li>
								<li>
									<p class="p-lg">● Website lacks good user experience</p>
								</li>
								<li>
									<p class="p-lg">● Website is deindexed by mistake</p>
								</li>

							</ul>

							<h4 class="h4-lg">Advanced SEO techniques rank #1 in GOOGLE</h4>

							<!-- Text -->
							<p class="p-lg">Online marketing is the new trend now. Digitalization has enabled customers to purchase products or avail any
							...
							<h4 class="h4-lg">Here are some techniques to rank number #1 on Google</h4>

							<!-- Title -->
							<h4 class="h4-lg">1. Improvise your old contents</h4>
