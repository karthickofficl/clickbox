					...
					<tbody>
						<tr class="sticky-header">
							...
							<td class="price-1">
								...
								<a href="https://clickboxagency.com/contacts/" target="_blank" aria-label="basic plan" title="basic plan" class="btn btn-sm btn-skyblue tra-grey-hover">Get Proposal</a>
							</td>
							<td class="price-1">
								<h5 class="h5-xs  txtblack">Advance </h5>
								<a href="https://clickboxagency.com/contacts/" target="_blank" aria-label="advance " title="advance" class="btn btn-sm btn-skyblue tra-grey-hover">Get Proposal</a>
							</td>
							<td class="price-1">
								<h5 class="h5-xs txtblack">Premium </h5>
								<a href="https://clickboxagency.com/contacts" target="_blank" aria-label="premium" title="premium" class="btn btn-sm btn-skyblue tra-grey-hover">Get Proposal</a>
							</td>
						</tr>
