				...
				<div class="col-md-7 col-lg-6">
					<div class="txt-block right-column wow fadeInLeft">
						...
						<ul class="simple-list">
							...
							<li class="list-item">
								<p class="p-lg">We are here to use client-centered practises.
								</p>
							</li>

							<li class="list-item">
								<p class="p-lg">Our team includes licenced professionals who can assist. </p>
							</li>

							<li class="list-item">
								<p class="p-lg">To increase client ROI, we offer cost-effective solutions.
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Article Submission (500–700 words)-2 Per Month</p>
								</li>
								<li>
								...
								<li>
									<p class="p-md"> Article promotion</p>
								</li>
								<li>
									<p class="p-md">Company profile creation </p>
								</li>
								<li>
								...
								<li>
									<p class="p-md">Local Citation - 5 per month </p>
								</li>
								<li>
									<p class="p-md">Social sharing- 15 per month</p>
								</li>
								<li>
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Article Submission (500–700 words)-4 Per Month</p>
								</li>
								<li>
								...
								<li>
									<p class="p-md">Forum posting </p>
								</li>
								<li>
									<p class="p-md">Q&A posting </p>
								</li>
								<li>
									<p class="p-md">Micro blogging</p>
								</li>
								...
								<li>
									<p class="p-md">Local Citation- 8 per month </p>
								</li>
								<li>
									<p class="p-md">Social sharing- 20 per month </p>
								</li>
								<li>
					...
					<div class="col">
						<div class="pricing-2-table bg-white mb-40 wow fadeInUp">
							...
							<ul class="features">
								...
								<li>
									<p class="p-md">Article Submission (500–700 words)-6 Per Month</p>
								</li>
								<li>
									<p class="p-md">Blog submission</p>
								</li>
								...
								<li>
									<p class="p-md">Local Citation- 10 per month </p>
								</li>
								<li>
									<p class="p-md">Social sharing- 25 per month </p>
								</li>
								<li>
								...
								<li>
									<p class="p-md">Video updating - 4 </p>
								</li>
								<li>
									<p class="p-md">Video optimization- 4</p>
								</li>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
											<b>What is the price of ORM?</b>
										</button>
									</h2>
									<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											<p class="p-lg">You must decide whether or not you want to save your company because the investment is inexpensive. The majority of people are aware that recovering their reputation is preferable to shutting down their business.
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingFive">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
											<b>Why is ORM important?</b>
										</button>
									</h2>
									<div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											<p class="p-lg">With the help of ORM, you may create and maintain a strong online reputation, enabling you to easily resist off strikes on your reputation and reduce their prominence. It assists in removing private information, such as addresses, from public databases, commonly referred to as "people search" databases.</p>
