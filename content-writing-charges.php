...
<body>
						...
						<div class="row d-flex align-items-center">
							<div class="col-md-5 col-lg-6">
								<div class="img-block left-column wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
									<img class="img-fluid" src="../images/39.png" alt="content writing packages">
								</div>
							</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-7 col-lg-6 order-last order-lg-1 order-md-1">
					<div class="txt-block left-column wow fadeInLeft">
						...
						<!-- TEXT BOX -->
						<div class="txt-box">
							<p class="p-lg txt-justify">We at <b>ClickBox</b> write articles for your company to help it establish value in the market so that you can experience the percussive sensation of writing.</p>
							<p class="p-lg txt-justify">Our talented writers are trying to provide you with fresh and distinctive material that will help you increase the number of leads for your company.</p>
							<p class="p-lg txt-justify">Your comfort is our top priority, and we really believe that our article writing services may do wonders for your company in order to best serve you. Budget friendly content writing rate is given by <b>ClickBox</b> to promote your company.</p>
						</div> <!-- END TEXT BOX -->
					</div>
				</div> <!-- END TEXT BLOCK -->
				<!-- IMAGE BLOCK -->
				<div class="col-md-5 col-lg-6 order-first order-lg-2 order-md-2">
					<div class="rel img-block right-column wow fadeInRight">
						<img class="img-fluid" src="../images/40.png" alt="content writing packages coimbatore">
					</div>
				</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-5 col-lg-6">
					<div class="rel img-block left-column wow fadeInRight">
						<img class="img-fluid" src="../images/41.png" alt="content writing packages new jersey">
					</div>
				</div>
				<!-- TEXT BLOCK -->
				<div class="col-md-7 col-lg-6">
					<div class="txt-block right-column wow fadeInLeft">
						...
						<!-- TEXT BOX -->
						<div class="txt-box">
							<p class="p-lg txt-justify">We provide you with our top article writing services to help your business expand its internet reach and attract a larger audience. By combining our blog service with SEO content creation services, we can help you expand your company's reach and attract more clients.</p>
							<p class="p-lg txt-justify">Keeping this in mind, we offer the most enjoyable, aesthetically pleasing, and genuinely fascinating blog post services with unique and innovative content that is relevant to your business. The top content writing services in India are friendly to search engine optimization and digital marketing, and they are thoroughly proofread for your benefit.</p>
						</div> <!-- END TEXT BOX -->
					</div>
				</div> <!-- END TEXT BLOCK -->
			</div>
	...
	<!-- SECTION #4 START -->
	<section class="bg-snow content-3 pt-30 pb-30  features-section division  ">
		<div class="container ">
			<div class="row justify-content-center">
				<div class="col-lg-10 col-xl-10">
					<div class="section-title title-01 mb-70">
					<h2 class="h3-xs text-center">Why Choose <span class="txtred">Clickbox for Content Writing</span> Services?</h3>
					</div>
				</div>
			</div>
...
<div class="col ">
			...
			<div class="row justify-content-center">
				<div class="col-lg-10 col-xl-8">
					<div class="section-title title-01 mb-80">
						<h2 class="h3-xs text-center">Our <span class="txtred">Content Writing Pricing</span></h2>
					</div>
				</div>
			</div>
			<!-- PRICING TABLES -->
	...
	</section> <!-- END FAQs-2 --><?php include('footer.php') ?>
