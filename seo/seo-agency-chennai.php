			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-7 col-lg-6">
					<div class="txt-block right-column wow fadeInLeft">
						...
						<!-- Title -->
						<h2 class="h2-xs">Top-Notch SEO Solutions Chennai</h2>
			...
			<div class="row">
				<div class="col">
					<div class="more-questions">
						<h5 class="h5-sm">Ready to make us your SEO consultant in Chennai? Let’s join together and increase your brand reach to the right audience and get your sales done! <a href="../contacts">Contact Us</a></h5>
					</div>
				</div>
			</div>
