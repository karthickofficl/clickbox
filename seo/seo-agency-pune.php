...
<head>
	...
	<meta name=keywords content="seo agency pune , seo services in pune ,seo companies in pune , best seo company pune" />
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-7 col-lg-6">
					<div class="txt-block right-column wow fadeInLeft">
						...
						<!-- Title -->
						<h1 class="h2-xs">Top-Notch SEO Solutions Pune</h1>
